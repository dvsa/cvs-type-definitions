export const schemas = [
  "enums/activityType.enum.json",
  "enums/closureReason.enum.json",
  "enums/defectLocation/horizontal.enum.json",
  "enums/defectLocation/lateral.enum.json",
  "enums/defectLocation/longitudinal.enum.json",
  "enums/defectLocation/vertical.enum.json",
  "enums/deficiencyCategory.enum.json",
  "enums/designTrainWeight.enum.json",
  "enums/emissionStandard.enum.json",
  "enums/euVehicleCategory.enum.json",
  "enums/fuelType.enum.json",
  ...
  "enums/odometerReadingUnits.enum.json",
  "enums/reasonForNotLoading.enum.json",
  "enums/refDataType.enum.json",
  "enums/sources.enum.json",
  "enums/testResult.enum.json",
  "enums/testStationType.enum.json",
  "enums/testStatus.enum.json",
  "enums/testTypeClassification.enum.json",
  "enums/typeOfTest.enum.json",
  "enums/unladenBodyType.enum.json",
  "enums/vehicleClassCode.enum.json",
  "enums/vehicleConfiguration.enum.json",
  "enums/vehicleLoadStatus.enum.json",
  "enums/vehicleSize.enum.json",
  "enums/vehicleSubclass.enum.json",
  "enums/vehicleType.enum.json",
  "enums/waitReason.enum.json",
  ...
  "v3/tech-record/enums/euVehicleCategoryCar.enum.json",
  "v3/tech-record/enums/euVehicleCategoryHgv.enum.json",
  "v3/tech-record/enums/euVehicleCategoryLgv.enum.json",
  "v3/tech-record/enums/euVehicleCategoryPsv.enum.json",
  "v3/tech-record/enums/euVehicleCategorySmallTrl.enum.json",
  "v3/tech-record/enums/euVehicleCategoryTrl.enum.json",
