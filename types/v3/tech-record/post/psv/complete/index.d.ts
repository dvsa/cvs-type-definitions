...
export type POSTPSVTechnicalRecordV3Complete = POSTPSVTechnicalRecordV3Complete1 & POSTPSVTechnicalRecordV3Complete2;
export type POSTPSVTechnicalRecordV3Complete1 = PSVBrakesComplete & ApplicantDetails;
...
export interface POSTPSVTechnicalRecordV3Complete2 {
  vin: string;
  systemNumber: string;
  primaryVrm: string;
