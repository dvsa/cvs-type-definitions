...
import * as trlData from "../resources/data/trlComplete.json";

const schemaName = "v3/tech-record/get/trl/complete/index.json";

describe("validate complete trl schema", () => {
