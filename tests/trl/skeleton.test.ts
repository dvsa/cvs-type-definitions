...
import * as trlData from "../resources/data/trlSkeleton.json";

const schemaName = "v3/tech-record/get/trl/skeleton/index.json";

describe("validate skeleton trl schema", () => {
