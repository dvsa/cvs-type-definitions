// AUTO-GENERATED from json-definitions/v3/tech-record/get/psv/skeleton/index.json. Do not edit by hand.
...
export const TechRecordGETPSVSkeletonSchema = z.object({
  "vin": z.string(),
  "partialVin": z.string(),
  ...
  "techRecord_vehicleSize": z.union([VehicleSizeSchema, z.null()]).optional(),
  "techRecord_seatsLowerDeck": z.number().int().nullable().optional(),
  "techRecord_seatsUpperDeck": z.number().int().nullable().optional(),
  ...
  "techRecord_recordCompleteness": z.string(),
  ...
  "techRecord_bodyType_description": BodyTypeDescriptionSchema,
  ...
  "techRecord_standingCapacity": z.number().int().nullable().optional(),
  "techRecord_speedLimiterMrk": z.boolean().nullable().optional(),
  "techRecord_tachoExemptMrk": z.boolean().nullable().optional(),
  "techRecord_euroStandard": z.union([EuroStandardSchema, z.null()]).optional(),
  "techRecord_fuelPropulsionSystem": z.union([FuelPropulsionSystemSchema, z.null()]).optional(),
  ...
  "techRecord_bodyMake": z.string().nullable(),
  "techRecord_bodyModel": z.string().nullable().optional(),
  "techRecord_chassisMake": z.string().nullable(),
  "techRecord_chassisModel": z.string().nullable(),
  ...
  "techRecord_brakes_dtpNumber": z.string().nullable(),
...
export type TechRecordGETPSVSkeleton = z.infer<typeof TechRecordGETPSVSkeletonSchema>;
