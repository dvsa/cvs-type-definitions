// AUTO-GENERATED from json-definitions/v3/tech-record/get/psv/complete/index.json. Do not edit by hand.
...
export const TechRecordGETPSVCompleteSchema = z.object({
  ...
  "techRecord_numberOfWheelsDriven": z.number().int().nullable(),
  ...
  "techRecord_dda": z.null().optional(),
  ...
  "techRecord_dimensions": z.null().optional(),
  ...
  "techRecord_microfilm": z.null().optional(),
...
export type TechRecordGETPSVComplete = z.infer<typeof TechRecordGETPSVCompleteSchema>;
