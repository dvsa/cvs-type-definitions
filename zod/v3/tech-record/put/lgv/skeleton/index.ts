// AUTO-GENERATED from json-definitions/v3/tech-record/put/lgv/skeleton/index.json. Do not edit by hand.
...
export const TechRecordPUTLGVSkeletonSchema = z.object({
  "vin": z.string(),
  ...
  "techRecord_hiddenInVta": z.boolean().optional(),
  "techRecord_updateType": z.string().optional(),
...
export type TechRecordPUTLGVSkeleton = z.infer<typeof TechRecordPUTLGVSkeletonSchema>;
