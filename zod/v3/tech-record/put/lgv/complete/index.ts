// AUTO-GENERATED from json-definitions/v3/tech-record/put/lgv/complete/index.json. Do not edit by hand.
...
export const TechRecordPUTLGVCompleteSchema = z.object({
  "vin": z.string(),
...
export type TechRecordPUTLGVComplete = z.infer<typeof TechRecordPUTLGVCompleteSchema>;
